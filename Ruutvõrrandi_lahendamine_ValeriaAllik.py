...
_a = Entry(aken, width=5, font=("Arial", 20), justify="center")
_b = Entry(aken, width=5, font=("Arial", 20), justify="center")
_c = Entry(aken, width=5, font=("Arial", 20), justify="center")
...
graafiku_nupp = Button(aken, text="Kuva graafik", font=("Arial", 15), command=grafik)
